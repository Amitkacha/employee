...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: buttonPadHorizon ?? 10.w, vertical: buttonPadVertical ?? 0.h),
              ...
              child: Center(
                child: showLoading
                    ...
                    : TextWidget(
                        ...
                        color: textColor ?? (isSelectedButton ? ColorManager.white : ColorManager.primary),
                      ),
              ),
            )),
      ),
